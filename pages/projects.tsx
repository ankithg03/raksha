...
const Projects = () => (
	<Page>
		...
		<Section>
			<div className="bg-gray-200 py-8 px-4 sm:px-6 lg:px-8 grid grid-cols-1 gap-4 md:grid-cols-2">
				<div className="max-w-xl mx-auto w-full h-full">
					<div className="p-10 bg-white rounded-lg shadow-xl overflow-hidden h-full">
				...
				<div className="max-w-xl mx-auto w-full h-full">
					...
					<p className="mt-4 max-w-lg text-sm leading-5 text-gray-700">Hackerrank solutions which consists.</p>
		...
		<Section>
			...
			<iframe title="Report Section" width="100%" height={'700px'}  src="https://app.powerbi.com/view?r=eyJrIjoiOGM4MTJiNDAtNThhYS00Y2FkLTllNDgtMDQ3NmY3ZDBkYmIyIiwidCI6ImRmMzVkNTc0LTlmYmEtNDhjZS1hMDczLTczNzg2OGQ3N2E0OCIsImMiOjZ9" frameBorder="0" allowFullScreen={true}></iframe>
		</Section>
	</Page>
)
